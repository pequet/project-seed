...
**Use the appropriate template below. Defaults for project (`DLS Commit Workflow`), author (`Benjamin Pequet`), GitHub repository (`pequet/dls-submodules-commit-workflow`), and support links are for this project.**
...
*   **ASCII Art (Tiers 1 & 2):** Use the DLS Commit Workflow ASCII art example provided in the templates.
